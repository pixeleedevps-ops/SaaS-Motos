...
begin
  ...
  if v_rol = 'empleado'::public.rol_usuario and p_sede_id is distinct from public.sede_actual() then
    raise exception 'Un empleado solo puede facturar en su sede' using errcode = '42501';
  end if;
...
begin
  ...
  if v_rol = 'empleado'::public.rol_usuario and v_sede is distinct from public.sede_actual() then
    raise exception 'Un empleado solo puede modificar facturas de su sede' using errcode = '42501';
  end if;
